...
def main():
    ...
    parser.add_argument('--config', default='configs/goal_based_training_config.yaml', help='配置文件路径')
    parser.add_argument('--experiment-name', default='goal_navigation_training', help='实验名称')
    parser.add_argument('--total-timesteps', type=int, default=100000, help='训练步数')
